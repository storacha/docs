...
Currently the best way to generate a DID (decentralized identifier) is to use the w3up JS CLI:
...
Once you have loaded your space DID, your private key and your delegation proofs, you can upload a CAR ([content archive file](https://docs.storacha.network/concepts/car/)) to Storacha.
