...
You can get started using Storacha right away from your command line using `w3`, our command line interface tool. Additionally, if you use the CLI, you can sign up using your Github credentials :tada:
