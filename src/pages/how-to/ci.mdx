...
Set `STORACHA_PRINCIPAL=<the signing key>` in the CI environment. The `storacha` commmand will use the value as the signing key to use. see: https://github.com/storacha/upload-service/tree/main/packages/cli#storacha_principal
