...
Please note that while you can create a space you cannot delete a space. Having an extra, empty space will not increase your billed data usage. We plan to offer the ability to delete spaces in the future.
