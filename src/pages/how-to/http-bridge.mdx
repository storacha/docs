...
[W3UP UCAN Bridge Protocol](https://github.com/storacha/specs/blob/main/w3-ucan-bridge.md) specification, but
they can also be generated for you by the [`w3` CLI](https://github.com/storacha/w3cli):
...
You can store individual files as [big as 5GB](https://github.com/storacha/w3infra/blob/26106e315e79bf8072d2bd052786e46563d9a1da/upload-api/service.js#L12-L16) in
...
into [our JavaScript implementation](https://github.com/storacha/w3up/blob/d6978d7ab299be76987c6533d18e6857f6998fe6/packages/upload-client/src/index.js#L38).
